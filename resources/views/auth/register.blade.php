                    ...
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small>This will be the character you will be paid on, enter it in the format
                                    <b>name-realm</b> for example Syelenn-Kazzak</small>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <small>This will be used for login, nothing will be sent to it</small>
